...
Version := "Valpha.0.1"
/* For check programs Status version
...
*/
goto, CodeStart ; place for version check 
Return
...
if(FileExist("info.gof"))
{
	...
	IDPre := Crypt.Encrypt.StrDecrypt(IDRead, "A12D3BA35S35J8KD3BA5K3SJBN5A3SD1ASD", 7, 6)
	PWPre := Crypt.Encrypt.StrDecrypt(PWRead, "A12D3BA35S35J8KD3BA5K3SJBN5A3SD1ASD", 7, 6)
	CheckedCH = Checked
...
{
	IDPack := Crypt.Encrypt.StrEncrypt(ID, "A12D3BA35S35J8KD3BA5K3SJBN5A3SD1ASD", 7, 6)
	PWPack := Crypt.Encrypt.StrEncrypt(PW, "A12D3BA35S35J8KD3BA5K3SJBN5A3SD1ASD", 7, 6)
